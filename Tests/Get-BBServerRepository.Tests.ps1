...
Describe 'when getting all repositories for a project' {
...
Describe 'when getting a specific repository' {
...
Describe 'when getting a specific repository with a wildcard' {
    $errors = @()
...
Describe 'when getting a repository that does not exist' {
    $Global:Error.Clear()
